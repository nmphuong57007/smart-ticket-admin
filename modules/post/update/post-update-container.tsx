...
import PostUpdateForm from "./post-update";


export default function PostUpdateContainer({ id }: { id: string }) {
    ...
    <CardWrapperTable
      title={
        <Button asChild variant="ghost" style={{ padding: 0 }}>
          <Link href={redirectConfig.contents}>
            <ArrowLeft />
            Danh sách bài viết
          </Link>
        </Button>
