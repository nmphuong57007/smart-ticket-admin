...
import BannerUpdateForm from "./banner-update";


export default function BannerUpdateContainer({ id }: { id: string }) {
    ...
    <CardWrapperTable
      title={
        <Button asChild variant="ghost" style={{ padding: 0 }}>
          <Link href={redirectConfig.points}>
            <ArrowLeft />
            Danh sách banner
          </Link>
        </Button>
